...
public class Home extends PageObject {
    public static final Target listaDeOpcionesDocumento = Target.the("lista de opciones").located(By.name("IdTipoDoc"));
    public static final Target opcionRUC = Target.the("opcion RUC").located(By.xpath("//option[@value='02']"));
